...
let xTrybe = ["pão", "queijo", "bacon", "alface", "ketchup", "queijo", "pão"];
let retira = [];
function retiraQueijo(){
   
    for (i = 0; i < xTrybe.length;  i += 1){
        let contador = xTrybe[i];        
        if(contador === "queijo"){
            retira.push()
...
// xTrybe.splice(2, 1, 'mostarda');
// let indiceEncontrado = xTrybe.indexOf('mostarda');
// console.log(indiceEncontrado);
// xTrybe.splice(indiceEncontrado, 1);
// console.log(xTrybe)
