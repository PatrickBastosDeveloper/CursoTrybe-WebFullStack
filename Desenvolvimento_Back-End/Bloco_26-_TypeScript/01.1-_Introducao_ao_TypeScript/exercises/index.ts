...
console.log(`Trapézio com base maior igual a 100cm, base menor igual a 70cm e altura igual a 50cm: ${Exercise.trapezio(100, 70, 50)}cm²`);
console.log(`Trapézio com base maior igual a 75cm, base menor igual a 50cm e altura igual a 35cm: ${Exercise.trapezio(75, 50, 35)}cm²`);
console.log(`Trapézio com base maior igual a 150cm, base menor igual a 120cm e altura igual a 80cm: ${Exercise.trapezio(150, 120, 80)}cm²`);
